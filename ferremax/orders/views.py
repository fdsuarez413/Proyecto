...
from shipping_addresses.models import ShippingAddres
...
from cart.utils import destroy_cart
...
def select_address(request):
    ...
    return render(request, 'orders/select_address.html', {
        'breadcumb': breadcrumb(address=True),
...
def cancel(request, cart, order): 
    ...
    return redirect('index') #Mirar mensaje
